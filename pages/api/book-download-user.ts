export default (data: { firstName: string }) => {
  return `
        ...
        <p>Or you can always read it on our website at your convenience: <a href="https://retirementby.design/books/the-pursuit-of-retirement">The Pursuit of Retirement</a>
        </p>
