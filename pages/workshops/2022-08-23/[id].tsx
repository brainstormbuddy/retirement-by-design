  ...
  return (
    <>
      ...
      <Box
        ...
        className={`${styles.workshopVideo}`}
      >
        {/* <video
          autoPlay={false}
              ...
              <Grid item xs={12} sm={6} md={6}>
                <div className="content">
                  ...
                  <div className={styles.authorInfo}>
                    <p>
                      Shawn is a Certified Financial Planner, and has been
                      helping people save, invest, and prepare for retirement
                      for over 20 years. As a Certified Financial Planner, Shawn
                      has the experience to guide you through the process to
                      retire by design, and can help you take stock of your
                      situation and develop a two-pronged financial strategy.
                    </p>
                  </div>
      ...
      <CTA
        ...
        sessionDate="August 23, 2022 at 12PM"
        workshopName="How Taxes Affect Your Retirement Plan - August 23, 2022"
...
export async function getServerSideProps(context: GetServerSideProps) {
  ...
  const speaker: any = await directus
    ...
    .readOne('bd9fe9e1-e877-4ee8-a4d0-d0242e54254c');
