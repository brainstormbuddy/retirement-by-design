  ...
  return (
    <>
      <Head>
        ...
        <meta
          ...
          content="Join Certified Financial Planner, Amber Lundin, for a
                    free one-hour workshop, as she walks you through limiting tax
              ...
              <Grid item xs={12} sm={8} md={8}>
                <article className={styles.articleHeader}>
                  ...
                  <h2 className="subheading">
                    ...
                    one-hour workshop, as she walks you through limiting tax
                    liabilities from your retirement plan.
                  </h2>
      ...
      <CTA
        ...
        sessionDate="April 12, 2022 at 12PM"
        workshopName="How Taxes Affect Your Retirement Plan - April 12, 2022"
