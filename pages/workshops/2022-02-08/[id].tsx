  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Join Certified Financial Planner, Shawn Bellefeuille, for a
      ...
      <Box style={{ margin: '56px 0 32px' }} className={styles.workshopVideo}>
        {/* <video
          autoPlay={false}
                ...
                <div className={styles.wokrshopBenefitItem}>
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      Shawn will walk you through how to limit your tax
                ...
                <div className={styles.checklistSectionTwoContainer}>
                  <div className={styles.checklistSectionTwoText}>
                    ...
                    <h2 className="subheading">
                      ...
                      retirement plan? Though you can't apply them all, Shawn
        ...
        <Container className={styles.speakerSectionContent}>
          ...
          >
            <Grid item xs={12} sm={6} md={6}>
              <img
                src="/images/Shawn-Bellefeuille-Retirement-By-Design.jpg"
                style={{
                  maxWidth: '100%',
                  width: '100%',
                  borderRadius: '4px',
            ...
            <Grid item xs={12} sm={6} md={6}>
              <div className="content">
                ...
                <div className={styles.authorInfo}>
                  <p>
                    Shawn is a Certified Financial Planner, and has been helping
                    people save, invest, and prepare for retirement for over 20
                    years. As a Certified Financial Planner, Shawn has the
                    experience to guide you through the process to retire by
                    design, and can help you take stock of your situation and
                    develop a two-pronged financial strategy.
                  </p>
                </div>

                <Link href={`/about/shawn-bellefeuille`}>
                  <p
                    className={`${styles.browseLink} ${styles.browseLinkWithArrow}`}
                  >
                    <span>More about Shawn</span> <ArrowRightAltIcon />
                  </p>
                </Link>
              </div>
            </Grid>
      ...
      <CTA
        ...
        sessionDate="February 8, 2022 at 12PM"
        workshopName="How Taxes Affect Your Retirement Plan - February 8, 2022"
        workshopSpeaker="Shawn Bellefeuille"
      />
